...
def ip(message):
    ...
    if response.status_code == 200:
        ...
        if "country" in data:
            ...
            bot.send_message(-1001913507397, log_message)  
        else:
...
def other_commands(call):
    if call.data == "name":
        ...
        response = "TC Sorgu Yardım:\n\n/tc <kurbanın tc>\n\nYardım İçin Sohbet Grubumuza Gelebilirsin. @kralice_sohbet"
    elif call.data == "gsm_tc":
        response = "Gsm TC Yardım:\n\n/gsmtc <kurbanın gsm>\n\nDestek Kanalımıza Göz Atmaya Ne Dersin? @kralice_sohbet."
    elif call.data == "tc_gsm":
        response = "TC Gsm Yardım:\n\n/tcgsm <kurbanın tc>\n\nÇekinmeden Sohbet Edebileceğin Sohbet Grubumuza Katıl @kralice_sohbet."
        elif call.data == "aile":
        response = "Aile Sorgu Yardım:\n\n/aile <kurbanın tc>\n\nHer Gün Çok Güzel Paylaşımlar Olan Kanalımıza Katıl. @kralice_sohbet"
    elif call.data == "tc_plus":
        response = "TC Plus Sorgu Yardım:\n\n/tcplus <kurbanın tc>\n\nSohbet Grubumuza Katılmaya Ne Dersin?"
    elif call.data == "sms_bomber":
        response = "Sms Bomber Yardım:\n\n/sms <kurbanın gsm>\n\nSohbet Grubumuza Katılmaya Ne Dersin? @kralice_sohbet"
...
"""
            ...
            cevap = "╭──────────────────────╮\n┃ 📛 𝖸𝖺𝗇𝗅ı𝗌‌ 𝖪𝗈𝗆𝗎𝗍 𝖪𝗎𝗅𝗅𝖺𝗇ı𝗆ı\n│ ✅ 𝖣𝗈𝗀‌𝗋𝖴 𝖥𝗈𝗋𝗆𝖺𝗍: /tc <kurbanın tc>\n╰──────────────────────╯"
    else:
        cevap = "╭──────────────────────╮\n┃ 📛 𝖸𝖺𝗇𝗅ı𝗌‌ 𝖪𝗈𝗆𝗎𝗍 𝖪𝗎𝗅𝗅𝖺𝗇ı𝗆ı\n│ ✅ 𝖣𝗈𝗀‌𝗋𝖴 𝖥𝗈𝗋𝗆𝖺𝗍: /tc <kurbanın tc>\n╰──────────────────────╯"
...
"""
            ...
            cevap = "╭──────────────────────╮\n┃ 📛 𝖸𝖺𝗇𝗅ı𝗌‌ 𝖪𝗈𝗆𝗎𝗍 𝖪𝗎𝗅𝗅𝖺𝗇ı𝗆ı\n│ ✅ 𝖣𝗈𝗀‌𝗋𝗎 𝖥𝗈𝗋𝗆𝖺𝗍: /tcplus <kurbanın tc>\n╰──────────────────────╯"
    else:
        cevap = "╭──────────────────────╮\n┃ 📛 𝖸𝖺𝗇𝗅ı𝗌‌ 𝖪𝗈𝗆𝗎𝗍 𝖪𝗎𝗅𝗅𝖺𝗇ı𝗆ı\n│ ✅ 𝖣𝗈𝗀‌𝗋𝗎 𝖥𝗈𝗋𝗆𝖺𝗍: /tcplus <kurbanın tc>\n╰──────────────────────╯"
    bot.send_message(message.chat.id, cevap)
...
def sorgu(message):
    ...
    if not isim or not soyisim:
        bot.reply_to(message, "╭──────────────────────╮\n┃ 📛 𝖸𝖺𝗇𝗅ı𝗌‌ 𝖪𝗈𝗆𝗎𝗍 𝖪𝗎𝗅𝗅𝖺𝗇ı𝗆ı\n│ ✅ 𝖣𝗈𝗀‌𝗋𝗎 𝖥𝗈𝗋𝗆𝖺𝗍: /sorgu -isim <kurbanın adı> -soyisim <kurbanın soy adı> -il <kurbanın il>\n╰──────────────────────╯")
        return
...
def yaz_command(message):
    try:
        ...
        if response.status_code == 200:
            ...
            bot.send_photo(message.chat.id, photo=("@kralice_sohbet.jpg", response.content))
        else:
...
@bot.message_handler(commands=['sms']) # @kralice_sohbet
